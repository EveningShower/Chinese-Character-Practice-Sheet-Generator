...
def generate_chinese_character_practice(
    paper_size: tuple, margins: tuple, square_size: int, filename: str, file_format: str
):
    """
    Generates a Chinese character practice sheet with custom paper size, margins, and square size.
    :param paper_size: Tuple of width and height in pixels (default is A4 paper size)
    :param margins: Tuple of width and height margins in pixels
    ...
    for i in range(
        margins_width, margins_width + num_squares_width * square_size, square_size
    ):
        for j in range(
            margins_height, margins_height + num_squares_height * square_size, square_size
        ):
